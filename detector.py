...
PATH_TO_CKPT = 'weights/faster_rcnn_inference_graph/frozen_inference_graph.pb'
...
if __name__ == "__main__":
    ...
    input_images = [os.path.join(input_image_dir, fname) for fname in os.listdir(input_image_dir)][::4]
    ...
    for i, image_path in enumerate(input_images):
        ...
        vis_util.visualize_boxes_and_labels_on_image_array(
            ...
            line_thickness=2)
        imsave("{}/{}.jpg".format(output_image_dir, str(i + 1).zfill(8)), image_np)
